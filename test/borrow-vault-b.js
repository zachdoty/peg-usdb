...
contract("borrow vault B test", (accounts) => {
    ...
    it("should borrow debt token from vault B", async () => {
        ...
        assert(amountBorrowed >= Number(await PegLogicContract.actualDebt.call(VaultBContract.address, borrowerVaultB)), 'actual debt is not equal to what is borrowed');
